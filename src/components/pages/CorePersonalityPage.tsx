...
export const CorePersonalityPage: React.FC<{ pageIdx: number, setPage: (idx: number) => void }> = () => {
  ...
  return (
    <div className="space-y-8 pb-6">
      ...
      <div className="px-2">
        <p className="text-slate-600 text-[14px] leading-relaxed font-medium text-left max-w-2xl mx-auto">{reportContent?.corePersonality?.description}</p>
      </div>

      <div className="space-y-4 px-1 pt-2">

        {/* Sun Sign Card */}
        <div className="relative p-5 md:p-6 bg-linear-to-r from-orange-50/80 to-white rounded-3xl shadow-sm hover:shadow-md transition-all border border-orange-100 flex flex-col md:flex-row md:items-center gap-4 group hover:-translate-y-1">
        ...
        {/* Moon Sign Card */}
        <div className="relative p-5 md:p-6 bg-linear-to-r from-indigo-50/80 to-white rounded-3xl shadow-sm hover:shadow-md transition-all border border-indigo-100 flex flex-col md:flex-row md:items-center gap-4 group hover:-translate-y-1">
        ...
        {/* Rising Sign Card */}
        <div className="relative p-5 md:p-6 bg-linear-to-r from-rose-50/80 to-white rounded-3xl shadow-sm hover:shadow-md transition-all border border-rose-100 flex flex-col md:flex-row md:items-center gap-4 group hover:-translate-y-1">
