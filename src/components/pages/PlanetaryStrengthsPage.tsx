        ...
        <div className="space-y-6">
          ...
          <div className="space-y-4">
            ...
            <div className="p-4.5 rounded-2xl bg-indigo-50/40  border border-indigo-50  space-y-3">
              <span className="px-2.5 py-1 bg-indigo-600 text-white text-[9px] uppercase font-normal tracking-wider rounded-md">
                YOGAKARAKA PLANETS
              </span>
            ...
            <div className="p-4.5 rounded-2xl bg-emerald-500/[0.02] border border-emerald-500/10 space-y-3">
              <span className="px-2.5 py-1 bg-emerald-600 text-white text-[9px] uppercase font-normal tracking-wider rounded-md">
                BENEFIC FORCES
              </span>
              <div className="flex flex-wrap gap-2">
            ...
            <div className="p-4.5 rounded-2xl bg-orange-500/[0.02] border border-orange-500/10 space-y-3">
              <span className="px-2.5 py-1 bg-orange-600 text-white text-[9px] uppercase font-normal tracking-wider rounded-md">
                MALEFIC CHALLENGES
              </span>
              <div className="flex flex-wrap gap-2">
