  ...
  return (
    <div className="space-y-8 pb-8">
      ...
      <div className="text-center space-y-3 mt-4">
        <p className="text-[12px] text-slate-500 font-medium uppercase tracking-widest">Chapter 01: Cosmic Origin</p>
        ...
        <h2 className="text-2xl md:text-3xl font-semibold text-slate-900 tracking-tight leading-tight max-w-xl mx-auto">
          Your Birth Star is <span className="text-transparent bg-clip-text bg-gradient-to-r from-orange-600 to-indigo-600 font-black">{data.birthStar.nkName} Nakshatra</span>
        </h2>
