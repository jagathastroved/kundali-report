    ...
    <div className="space-y-8 pb-8">
      ...
      <div className="text-center space-y-3 mt-4">
        ...
        <h2 className="text-2xl md:text-3xl font-semibold text-slate-900 tracking-tight leading-tight max-w-xl mx-auto">
          {reportContent?.birthStar?.titlePrefix} <span className="text-transparent bg-clip-text bg-linear-to-r from-orange-600 to-indigo-600 font-black">{data?.birthStar?.nkName} Nakshatra</span>
        </h2>
      ...
      {/* Main Description */}
      <div className="px-2">
        <div className="p-6 rounded-3xl bg-linear-to-r from-indigo-50/50 to-white border border-indigo-100 shadow-sm relative overflow-hidden">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 pt-4">
        ...
        <div className="relative p-6 rounded-3xl bg-gradient-to-br from-orange-50/80 to-white border border-orange-100 shadow-sm hover:shadow-md transition-all group hover:-translate-y-1">
          <div className="absolute -top-3 left-6 bg-linear-to-r from-orange-500 to-orange-400 text-white px-4 py-1 text-[11px] font-bold uppercase rounded-full shadow-md tracking-wider flex items-center">
        ...
        <div className="relative p-6 rounded-3xl bg-gradient-to-br from-indigo-50/80 to-white border border-indigo-100 shadow-sm hover:shadow-md transition-all group hover:-translate-y-1">
          <div className="absolute -top-3 left-6 bg-linear-to-r from-indigo-600 to-indigo-500 text-white px-4 py-1 text-[11px] font-bold uppercase rounded-full shadow-md tracking-wider flex items-center">
