      ...
      return (
        <div className="space-y-6">
          <div className="space-y-1">
            <span className="text-[10px] font-normal uppercase text-[#FE7950] tracking-widest block">Chapter 06</span>
          ...
          <div className="p-4 rounded-2xl bg-[#FEF6E4] text-center border-l-4 border-l-[#FE7950] border border-[#FDE5A9] shadow-sm">
            ...
            <span className="text-sm font-normal text-[#FE7950] uppercase tracking-wider">{dominantElement}</span>
          </div>
